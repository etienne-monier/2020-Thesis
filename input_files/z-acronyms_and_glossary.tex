...
\newacronym{admm}{ADMM}{\textit{alternating direction method of multipliers}}
...
\newglossaryentry{g-Amn-row}{type=notgen, 
    name={\ensuremath{\mathbf{A}_{m:n,:}}},
    description={Concaténation des lignes de la matrice \gls{g-A} d'indices compris entre $m$ et $n$},
    sort={10}}

\newglossaryentry{g-AI-row}{type=notgen, 
    name={\ensuremath{\mathbf{A}_{\mathcal{E},:}}},
    description={Concaténation des lignes de la matrice \gls{g-A} indexées par l'ensemble $\mathcal{E}$},
    sort={11}}
...
\newglossaryentry{I}{
    ...
    description={Ensemble des indices des positions spatiales acquises},
    shape={\gls{N}},
    sort={02}
}
...
\newglossaryentry{Xh}{
    ...
    description={Image reconstruite},
    shape={\gls{M} \ensuremath{\times} \gls{P}},
    sort={09}
}
...
\newglossaryentry{Nc}{
    type=demelange,
    name={\ensuremath{N_c}},
    description={Nombre de composantes élémentaires},
    %shape={\gls{M} \ensuremath{\times} \gls{P}},
    sort={1}
}
...
\newglossaryentry{Mu}{
    ...
    shape={\gls{M} \ensuremath{\times} \gls{Nc}},
    sort={2}
}
...
\newglossaryentry{A}{
    ...
    shape={\gls{Nc} \ensuremath{\times} \gls{P}},
    sort={3}
}
