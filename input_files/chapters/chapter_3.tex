...
% la résolution au sens pouvoir séparateur dépend de l'instrument et est relativement fixée. Le nombre de pixels et la zone échantillonnée sont facilement choisis par l'expérimentateur et donc on va beaucoup jouer là-dessus.
...
Cette section décrit les algorithmique pour résoudre les problèmes d'optimisation~\eqref{eq-s2n} et \eqref{eq-3s}. Tous deux reposent sur l'algorithme \gls{fista}~\cite{beck_fast_2009} présenté dans la section suivante.
...
Le premier protocole, noté $\mathcal{P}_1$, consiste à échantillonner le spectre pour toutes les positions spatiales ($r=1$), mais en réduisant la durée d'acquisition $\Delta t$ pour chaque pixel. La baisse de SNR peut être réduite à l'aide d'une étape de débruitage a posteriori.
%
...
\begin{figure}
    ...
    \subfigure[\protect\label{fig-lr-real-data-spectra-a}Position des pixels et des zones représentées]{
        \includegraphics[width=0.4\textwidth]{img/chapitre3/figure12/loc-image-bis.png}}\\
    \subfigure[\protect\label{fig-lr-real-data-spectra-b}Spectres centraux]{
        \includegraphics[width=\textwidth]{img/chapitre3/figure12/spectra-center.pdf}}\\
    \subfigure[\protect\label{fig-lr-real-data-spectra-c}Spectres moyennés]{
        \includegraphics[width=\textwidth]{img/chapitre3/figure12/spectra-mean.pdf}}\\
    \caption{\protect\label{fig-lr-real-data-spectra}
        ...
        \subref{fig-lr-real-data-spectra-c}~Représentation de la moyennes des spectres pour chaque zone.
    }
\end{figure}
